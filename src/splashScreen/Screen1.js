         ...
         <View style={style.container}>
            <View style={{ width: "100%", backgroundColor: colors.wh0, flex: 1 }}>
               ...
               <View style={{ width: "100%", height: 250, marginTop: 10, display: "flex", justifyContent: "center", alignItems: "center" }}>
                  <AntDesign name="disconnect" size={64} color={colors.bk0} />
                  <Text style={{ fontSize: 16, color: colors.bk0, paddingLeft: 20, paddingTop: 15 }}>{"github.com/project-emmiter-site"}</Text>
               </View>
            </View>
            ...
            >
               ...
               <Text style={{ color: colors.wh0 }}>  Entendo, continuar...</Text>
            </TouchableOpacity>
         </View>
      </>
   );
